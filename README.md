...
The active desktop has no visual filters or CRT overlay. The green-shard effect and its preset are preserved in `archived-assets/green-shards/`, disconnected from the running application. The intro uses only `IntroShort.mp4`.
